...
<head>
  ...
  <script src="<?php echo URLROOT ?>/scripts/azph_hms.js" type="text/javascript"></script>
  ...
  <link href="<?php echo URLROOT ?>/images/favicon.ico" rel="shortcut icon" type="image/x-icon">
  <link href="<?php echo URLROOT ?>/images/webclip.png" rel="apple-touch-icon">
</head>
<body>  
  <main>
