<div class="filter-bar">
        ...
        <form class='filter-form' action="<?php echo URLROOT; ?>/user/viewAll" method="POST" id="filter-issues-form" name="filter-issues-form" data-name="Filter Issue Form">
            ...
            <div class="filter-form-group">
                ...
                <select id="classification" name="classification" required data-name="classification" class="w-select" onChange="this.form.submit()">
                    ...
                    <option value="%INFRASTRUCTURE%" <?php if($data['classification']=='%INFRASTRUCTURE%'):?>selected<?php endif?>>Infrastructure</option>
                    <option value="%PLUMBING%" <?php if($data['classification']=='%PLUMBING%'):?>selected<?php endif?>>Plumbing</option>
    ...
    <div class="filter-bar-group">
        ...
        <div class="filter-form-group">
            ...
            <button type="submit" class="btn-filled purple w-button">Search</button>
        </div>
